...
def main():
    ...
    with gr.Blocks(theme=gr.themes.Citrus(), title="LangGraph RAG with Multi-AI Agents 🐥", css=css, js=js) as demo:
        gr.Markdown("## LangGraph RAG with Multi-AI Agents 🐥", elem_classes="subtitle")
        ...
        gr.Markdown("⚠️ **Note:** LangGraph RAG with Multi-AI Agents only accepts documents in these formats: '.pdf', '.docx', '.txt', '.md'", elem_classes="text")
